...
public class M_HorVotePresenter extends BasePresenter {
    private M_MineVoteModel mModel;
    private M_HorVotesActivity mVew;
    private Context mContext;
    private boolean isLoading = false;
    private boolean no_data = false;


    public M_HorVotePresenter(M_HorVotesActivity mVew, Context mContext) {
        this.mVew = mVew;
