...
public class DirectPaYAdapter extends  AppBaseAdapter{

    private Context mContext;
    private int mType;
    private List<RechargeListBean> mDataIn;
    private int mLayout = R.layout.adapter_banklist;
    private SelectPayWay mView;
    private int selectPosition = -1;
    private ArrayList<CheckBox> listCollection = new ArrayList<>();

    public DirectPaYAdapter(SelectPayWay view, Context context, List<RechargeListBean> data,int selectPosition) {
        super(context);
        mContext = context;
        mDataIn = data;
        mView = view;
