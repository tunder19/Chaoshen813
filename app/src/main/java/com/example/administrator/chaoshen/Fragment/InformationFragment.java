...
import com.example.administrator.chaoshen.widget.NavitationLayout.NavitationFollowScrollLayout;
...
public class InformationFragment extends BaseFragment {
    ...
    public void onInit(View root) {
        ...
        mPresenter = new InformationPresenter(this, getContext());
        firstShow=false;
        //loadData();
    ...
    private void setViewPager(boolean load_data) {
        ...
        if (load_data) {
            ...
            for (int i = 0; i < getListCache().size(); i++) {
                ...
                fragments1.add(InformaitionListFragment.newInstance(getListCache().get(i).getId(),isFirstFragment));
            }
        } else {
            ...
            for (int i = 0; i < mData.size(); i++) {
                ...
                fragments1.add(InformaitionListFragment.newInstance(mData.get(i).getId(),isFirstFragment));
            /*if (i == 0) {
...
/*
    ...
    private void setTabPagerIndicator() {
        ...
        indicator.setIndicatorColor(Color.parseColor("#C8152D"));// 设置底部导航线的颜色
        indicator.setTextColorSelected(Color.parseColor("#C8152D"));// 设置tab标题选中的颜色
