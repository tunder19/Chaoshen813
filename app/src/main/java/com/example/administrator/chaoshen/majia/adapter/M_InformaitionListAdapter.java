...
public class M_InformaitionListAdapter extends AppBaseAdapter {
    List<ArticleListBean> data = new ArrayList<>();
    private int layout= R.layout.information_list_item;
    private Context mContext;
    private M_InformaitionListFragment mView;


    public M_InformaitionListAdapter(Context context, List<ArticleListBean> data, M_InformaitionListFragment mView) {
        super(context);
        mContext=context;
        this.mView=mView;
        this.data=data;
