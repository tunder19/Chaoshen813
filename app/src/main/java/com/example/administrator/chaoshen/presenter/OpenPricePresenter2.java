...
public class OpenPricePresenter2 {
    private OpenPriceModel mModel;
    private OpenPrieceFragment mVew;
    private OpenScoreFragment2 mVew2;

    private Context mContext;
    private boolean isLoading = false;

    public OpenPricePresenter2(OpenPrieceFragment mVew, Context mContext) {
        this.mVew = mVew;
        this.mContext = mContext;
        mModel = new OpenPriceModel(mContext);
    }

    public OpenPricePresenter2(OpenScoreFragment2 mVew2, Context mContext) {
        this.mVew2 = mVew2;
        this.mContext = mContext;
        mModel = new OpenPriceModel(mContext);
    }
