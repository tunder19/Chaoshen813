...
public class Any9Fragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2, View.OnClickListener {
    ...
    public static Any9Fragment newInstance() {

        Bundle args = new Bundle();

        Any9Fragment fragment = new Any9Fragment();
    ...
    protected void initViews(View root) {
        ...
        mPresenter.getWinLoseLottery(new WinLoseNetBean("r9", null));
   ...
   /* // 通过代码方式控制进入加载更多状态
    ...
    public void getDataSucdess(String status, List<WinloseMatchesBean> beans, int position) {
        ...
        if (mData == null || mData.size() == 0) {
            ...
            if (null != mData.get(position).getMatches()) {
                adapter = null;
                if (adapter == null) {
                    adapter = new WinLoseAdapter(this, getContext(), mData.get(position).getMatches(), mData.get(position).getOnsale());
                } else {
    ...
    public void setSelectData(int num) {
        selectNum = num;
        has_select.setText("已选" + selectNum + "场  (请至少选择9场赛事)");
    }
    ...
    public void refreshZhu() {
        ...
        if (selectNum >= 9) {
            ...
            int zhushu = WinloseUtil.bets(bets, true);
    ...
    public void showLoginTips(BuyWinLostSuccess info) {
        ...
        dialog.setSureButton("查看订单", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.putString(IntentKey.LOTTERY_RULE, "r9");
