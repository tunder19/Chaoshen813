...
public class NotificationsUtils {
    ...
    public static boolean isNotificationEnabled(Context context) {
        ...
        @SuppressLint("WrongConstant") AppOpsManager mAppOps =
    ...
    public static void toNotifySetting(BaseActivity  activity){
        if (!NotificationsUtils.isNotificationEnabled(activity)) {
            ChaoshenAlertDialog dialog =new ChaoshenAlertDialog(activity.getContext());
            dialog.setMessage("检测到您没有打开通知权限，是否去打开");
            ...
            dialog.setCancelButton("确定", new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (Build.VERSION.SDK_INT >= 9) {
                        ...
                        localIntent.setData(Uri.fromParts("package", activity.getContext().getPackageName(), null));
